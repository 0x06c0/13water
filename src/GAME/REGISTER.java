...
public class REGISTER {
	...
	void Register() {
		...
		Icon icon = new ImageIcon("images/注册.jpg");
		Icon denglu = new ImageIcon("icon/注册icon.png");
			...
			public void actionPerformed(ActionEvent e) {
				...
				try 
	        	{
	        		...
	        		if(jsonb.getInt("status")!=0) {
	        			...
	        			JP.setOpaque(true);
	        			JTextField xinxi = new JTextField("注册失败！！！ ");
	        			...
	        			JP.setBounds(22, 22, 181, 108);
	        			JP.setOpaque(true);
	        			JTextField xinxi = new JTextField("注册成功！！！");
	        			xinxi.setBounds(22, 22, 181, 50);
	        			xinxi.setEnabled(false);
	        			Font x = new Font("Serif",0,20);
	        			xinxi.setFont(x);
